...
<body class="content-animate">
	...
	<div class="page-loader">
		...
		<div class="loader font-face1">wait...
		</div>
	</div>
	<!-- PAGE
		==================================================-->
	<div id="top" class="page">
		...
		<main class="cd-main-content">
					...
					<div class="table-center-text">
						<div class="container">
							...
							<div class="local-scroll">
								...
								<a href="<?php echo site_url('blog'); ?>" class="btn bg-black whitre-color hidden-xs">Journey</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="table-content">	
						<div class="table-center-text">
							<div class="container">		
								...
								<h1 class="font-face1 heading2 fw700 mb-40 mb-xs-30"><?php echo $caption_2; ?></h1>
								<div class="local-scroll">
									<a href="<?php echo site_url('visimisi'); ?>" class="btn bg-black white-color">Visimisi</a>
									<span class="btn_seperator"></span>
			...
			<section id="thoughts" class="page-section big-section">
				<div class="shadow-title shadow-gray unselectable parallax-1">POST</div>
				<div class="container">
					<div class="row">
