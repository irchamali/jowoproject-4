...
class Category extends CI_Controller
{
	...
	{
		$data = $this->category_model->get_product_by_category($slug);
		if ($data->num_rows() > 0) {
			$q = $data->row_array();
			...
			$x['data'] = $this->category_model->product_category_perpage($category_id, $offset, $limit);
			...
			$this->load->view('product_category_view', $x);
		} else {
			redirect('product');
		}
	}
